...
SELECT P1.ArtPiece_Style, AVG(P1.Price) AS averagePrice
FROM ArtPiece P1
GROUP BY P1.ArtPiece_Style
HAVING P1.ArtPiece_Style IN (SELECT P2.ArtPiece_Style
                            FROM ArtPiece P2
                            WHERE P2.ArtPiece_DateCreated >= 1990-01-01)